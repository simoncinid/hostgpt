                    ...
                    <div className="space-y-3">
                      <div className="grid grid-cols-2 gap-3">
                        <div>
                          <label className="block text-xs font-medium text-gray-700 mb-1">
                            {t.stampe.checkout.form.firstName} *
                          </label>
                          <input
                            type="text"
                            value={shippingAddress.firstName}
                            onChange={(e) => handleInputChange('firstName', e.target.value)}
                            className={`w-full px-3 py-2 text-sm border rounded-lg focus:ring-1 focus:ring-primary focus:border-transparent ${
                              errors.firstName ? 'border-red-500' : 'border-gray-300'
                            }`}
                            placeholder="Mario"
                          />
                        ...
                        <div>
                          <label className="block text-xs font-medium text-gray-700 mb-1">
                            {t.stampe.checkout.form.lastName} *
                          </label>
                          <input
                            type="text"
                            value={shippingAddress.lastName}
                      ...
                      <div>
                        ...
                        <input
                          ...
                          value={shippingAddress.company}
                          onChange={(e) => handleInputChange('company', e.target.value)}
                          className="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-1 focus:ring-primary focus:border-transparent"
                          placeholder="Nome Azienda"
                        />
                      </div>
                      ...
                      <div>
                        <label className="block text-xs font-medium text-gray-700 mb-1">
                          {t.stampe.checkout.form.address} *
                        </label>
                        <div className="relative">
                          <input
                            type="text"
                      ...
                      <div>
                        <label className="block text-xs font-medium text-gray-700 mb-1">
                          {t.stampe.checkout.form.streetNumber} *
                        </label>
                        <input
                          type="text"
                          value={shippingAddress.streetNumber}
